              ...
              <div className="flex flex-1 items-center justify-between gap-4 px-6 py-5">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-cream-dim">
                      {show.venue}, {show.city} &middot; {formatTime(show.date)}
                    </p>
                  </div>
                </div>
                ...
                {show.ticketUrl && (
                  <a
                    ...
                    className="shrink-0 rounded-sm border border-amber/30 bg-amber/5 px-5 py-2 text-sm font-medium tracking-wide text-amber transition-all duration-200 hover:border-amber hover:bg-amber/10 hover:text-amber-light"
                  >
                    Details
                  </a>
                )}
